 ...
 *
 * A tool is scanned, not read: three sentences above the data pushes the actual
 * content below the fold and reads like documentation embedded in a product.
 * The full argument lives on the landing page and /how-it-works, where someone
 * who wants it goes looking -- and the guided tour below already says what to
 * do next. What stays here is the one sentence that names what a row IS.
 */
function PageHead() {
  return (
    <div className="mb-5">
      ...
      <p className="mt-1 text-[13px] text-ink-2">
        Clusters of accounts that share infrastructure, ranked by how organised the pattern
        looks rather than coincidental.
      </p>
    </div>
  )
}
